            ...
            If (Not SubExists) Then
                ...
                If SubscriptionTask Is Nothing OrElse (SubscriptionTask.Status <> Threading.Tasks.TaskStatus.Created And
                    ...
                    If SubscriptionTask IsNot Nothing Then
                        '    Console.WriteLine("Status=" & SubscriptionTask.Status.ToString)
                        ' Console.WriteLine(MyObjectID & "-subTaskStatA=" & SubscriptionTask.Status.ToString)
                    End If
                    'Console.WriteLine(MyObjectID & "-Starting sub task")
                ...
                End If
                'Console.WriteLine(MyObjectID & "-subTaskStat=" & SubscriptionTask.Status.ToString)
