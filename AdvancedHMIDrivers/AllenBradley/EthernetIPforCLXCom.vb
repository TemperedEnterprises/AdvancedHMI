        ...
        Set(value As String)
            If Not String.IsNullOrEmpty(value) Then
                If MyBase.IPAddress <> value Then
                    ...
                    '            'Dim prop() = t.GetProperties
                    '            ''name = prop.GetValue(Me, Nothing).ToString()

                    '            Dim p As New IniParser(value)

                    '            If p.SectionExists("IPADDRESS") Then
                    '                MyBase.IPAddress = p.GetSetting("IPADDRESS")
                    '            ElseIf p.SectionExists(m_site.Name & ".IPADDRESS") Then
                    '                MyBase.IPAddress = p.GetSetting(m_site.Name & "IPADDRESS")
                    '            End If
                    '        End If
                    '        m_IniFileName = value
                    '        m_HostName = ""
